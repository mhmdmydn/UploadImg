...
public class PermissionsUtil {
    ...
    public static final class Permission {
        ...
        public static final class Calendar {
            ...
            private static final String MSG = "kalender";
        }

        public static final class Camera {
            public static final String CAMERA = Manifest.permission.CAMERA;
            private static final String MSG = "kamera";
        }
        ...
        public static final class Contacts {
            ...
            private static final String MSG = "kontak";
        }

        public static final class Location {
            public static final String ACCESS_FINE_LOCATION = Manifest.permission.ACCESS_FINE_LOCATION;
            public static final String ACCESS_COARSE_LOCATION = Manifest.permission.ACCESS_COARSE_LOCATION;
            private static final String MSG = "Lokasi";
        }

        public static final class Microphone {
            public static final String RECORD_AUDIO = Manifest.permission.RECORD_AUDIO;
            private static final String MSG = "Audio";
        }
        ...
        public static final class Phone {
            ...
            private static final String MSG = "Telepon";
        }

        public static final class Sensors {
            public static final String BODY_SENSORS = Manifest.permission.BODY_SENSORS;
            private static final String MSG = "Sensor";
        }
        ...
        public static final class Sms {
            ...
            private static final String MSG = "SMS";
        }

        public static final class Storage {
            public static final String READ_EXTERNAL_STORAGE = Manifest.permission.READ_EXTERNAL_STORAGE;
            public static final String WRITE_EXTERNAL_STORAGE = Manifest.permission.WRITE_EXTERNAL_STORAGE;
            private static final String MSG = "Storage";
        }
    }
    ...
    private String mPositiveText = "Beri Izin";
    private String mNegativeText = "Batal";
